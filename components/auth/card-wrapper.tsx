                ...
                {showOAuth && (
                    <div className="flex flex-col gap-y-2 max-w-md">
                        ...
                        <div className="flex justify-center gap-2 items-center">
                            <Button variant={"outline"} onClick={async ()=> await signIn("google",{redirectTo: DEFAULT_LOGIN_REDIRECT})} className="w-full"><FcGoogle/>&nbsp;Google</Button>
                            <Button variant={"outline"} onClick={async ()=> await signIn("apple",{redirectTo: DEFAULT_LOGIN_REDIRECT})} className="w-full"><FaApple/>&nbsp;Apple</Button>
                        </div>
                    </div>)}
            </CardContent>
